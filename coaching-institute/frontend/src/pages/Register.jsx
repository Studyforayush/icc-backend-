...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Registration successful! Welcome to Excellence Academy');
      navigate('/');
    } catch (err) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 font-heading">Get Started</h1>
            <p className="text-gray-600 mt-2">Join Excellence Academy today</p>
          </div>
